...
namespace tetirs
{
    ...
    {
        public Sblock(Brick[] tetrominoShape, int x, int y, int orientation, ConsoleColor color) : base(tetrominoShape, x, y, orientation, color)
        {
        ...
        public override void CreateBrick(Brick[] tetrominoShape,int x, int y, int orientation)
        {
            ...
            tetrominoShape[1].PositionX = 2;
            tetrominoShape[1].PositionY = 0;
            tetrominoShape[2].PositionX = 0;
